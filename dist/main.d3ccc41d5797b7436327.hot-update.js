...
function initSliders() {
	...
	if (document.querySelector('.swiper')) { // Вказуємо склас потрібного слайдера
		...
		new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper', { // Вказуємо склас потрібного слайдера
			...
			modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination],
			observer: true,
			loop: true,
			observeParents: true,
			slidesPerView: 1,
